#program je sestavljen iz njihovega spline fita in na koncu mojega klica funkcije in zapisa normalizirane krivulje na datoteko
...
from spline_comparisson.robust_mean import robust_mean

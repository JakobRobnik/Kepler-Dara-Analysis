...
def read_kepler_light_curve(filenames,
  ...
  for filename in filenames:
    with fits.open(gfile.Open(filename, "rb")) as hdu_list:
      ...
      #you can use PDCSAP_FLUX for pre corrected flux (long term trends are removed)
      #or SAP_FLUX for flux with long term trends.
      #  difference is shown in for example https://docs.lightkurve.org/tutorials/01-lightcurve-files.html
